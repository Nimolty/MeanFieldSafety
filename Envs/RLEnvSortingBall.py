...
class Sorting:
    ...
    def get_positions(self, condition=None, sigma=None):
        """
...
class RLSorting(Sorting):
    ...
    def reset(self, condition=None, sigma=None):
        self.num_episodes += 1
       # t_s = time.time()

        blue_positions = self.get_positions(condition, sigma)
